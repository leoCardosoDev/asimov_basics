...
def se_tiver_nomes_especificos(diretorio):
  if diretorio.is_dir() and not diretorio.name.startswith('.') and not diretorio.name == 'node_modules':
    return True
  return False
  
# Retorna tamanho dos diretórios
...
caminho = Path.home() / 'cursos/python'
